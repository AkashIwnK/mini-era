; ModuleID = './output//test.baseline.target.extract.ll'
source_filename = "src//viterbi_spec.c"
...
for.cond48.preheader:                             ; preds = %while.body
  ...
  %16 = load i8, i8* %arrayidx42, align 1, !tbaa !2
  ...
  %17 = load i8, i8* %arrayidx547, align 1, !tbaa !2
  %arrayidx551 = getelementptr inbounds i8, i8* %arrayidx31, i64 3
  %18 = load i8, i8* %arrayidx551, align 1, !tbaa !2
...
if.else:                                          ; preds = %for.body56
  %24 = load i8, i8* %arrayidx89, align 1, !tbaa !2
...
for.body229:                                      ; preds = %for.body170, %for.body229
  ...
  %41 = load i8, i8* %arrayidx231, align 1, !tbaa !2
  %arrayidx234 = getelementptr inbounds [16 x i8], [16 x i8]* %m1, i64 0, i64 %indvars.iv1082
  %42 = load i8, i8* %arrayidx234, align 1, !tbaa !2
  ...
  %43 = load i8, i8* %arrayidx243, align 1, !tbaa !2
  %arrayidx246 = getelementptr inbounds [16 x i8], [16 x i8]* %m3, i64 0, i64 %indvars.iv1082
  %44 = load i8, i8* %arrayidx246, align 1, !tbaa !2
...
for.body362:                                      ; preds = %for.body299, %for.body362
  ...
  %59 = load i8, i8* %arrayidx364, align 1, !tbaa !2
  %add366 = add i8 %59, 1
...
for.end606:                                       ; preds = %for.inc604
  %88 = load i8, i8* %l_mmresult1187, align 16, !tbaa !2
...
for.cond640.preheader:                            ; preds = %for.body616
  ...
  %89 = load i8, i8* %arrayidx6481045, align 1, !tbaa !2
...
for.body616:                                      ; preds = %for.body616, %for.end606
  ...
  %90 = load i8, i8* %arrayidx618, align 1, !tbaa !2
...
for.body644:                                      ; preds = %for.cond640.preheader, %for.body644
  ...
  %95 = load i8, i8* %arrayidx648, align 1, !tbaa !2
...
for.body668:                                      ; preds = %for.body668, %for.cond665.preheader
  ...
  %98 = load i8, i8* %arrayidx676, align 1, !tbaa !2
