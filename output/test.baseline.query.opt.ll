; ModuleID = './output//test.baseline.query.extract.ll'
...
define dso_local void @do_decoding(i32 %in_n_data_bits, i32 %in_cbps, i32 %in_ntraceback, i8* nocapture readonly %inMemory, i8* nocapture %outMemory) local_unnamed_addr #1 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %l_metric0_generic1184) #2
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %l_metric1_generic1185) #2
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %l_path0_generic1172) #2
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %l_path1_generic1186) #2
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %l_mmresult1187) #2
  %0 = getelementptr inbounds [24 x [64 x i8]], [24 x [64 x i8]]* %l_ppresult, i64 0, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 1536, i8* nonnull %0) #2
...
while.body.lr.ph:                                 ; preds = %while.cond.preheader
  %1 = getelementptr inbounds [16 x i8], [16 x i8]* %m0, i64 0, i64 0
  %2 = getelementptr inbounds [16 x i8], [16 x i8]* %m1, i64 0, i64 0
  %3 = getelementptr inbounds [16 x i8], [16 x i8]* %m2, i64 0, i64 0
  %4 = getelementptr inbounds [16 x i8], [16 x i8]* %m3, i64 0, i64 0
  %5 = getelementptr inbounds [16 x i8], [16 x i8]* %decision0, i64 0, i64 0
  %6 = getelementptr inbounds [16 x i8], [16 x i8]* %decision1, i64 0, i64 0
  %7 = getelementptr inbounds [16 x i8], [16 x i8]* %survivor0, i64 0, i64 0
  %8 = getelementptr inbounds [16 x i8], [16 x i8]* %survivor1, i64 0, i64 0
  %9 = getelementptr inbounds [16 x i8], [16 x i8]* %metsv, i64 0, i64 0
  %10 = getelementptr inbounds [16 x i8], [16 x i8]* %metsvm, i64 0, i64 0
  %11 = getelementptr inbounds [16 x i8], [16 x i8]* %shift0, i64 0, i64 0
  %12 = getelementptr inbounds [16 x i8], [16 x i8]* %shift1, i64 0, i64 0
  %13 = getelementptr inbounds [16 x i8], [16 x i8]* %tmp0, i64 0, i64 0
  %14 = getelementptr inbounds [16 x i8], [16 x i8]* %tmp1, i64 0, i64 0
...
for.body17:                                       ; preds = %for.body17, %for.body
  ...
  store i8 0, i8* %arrayidx21, align 1, !tbaa !11
...
for.cond48.preheader:                             ; preds = %while.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %sym0v1065) #2
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %sym1v1066) #2
  %15 = load i8, i8* %arrayidx31, align 1, !tbaa !11
  %arrayidx42 = getelementptr inbounds i8, i8* %arrayidx31, i64 1
  %16 = load i8, i8* %arrayidx42, align 1, !tbaa !11
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %sym0v1065, i8 %15, i64 16, i1 false)
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %sym1v1066, i8 %16, i64 16, i1 false)
  %arrayidx547 = getelementptr inbounds i8, i8* %arrayidx31, i64 2
  %17 = load i8, i8* %arrayidx547, align 1, !tbaa !11
  %arrayidx551 = getelementptr inbounds i8, i8* %arrayidx31, i64 3
  %18 = load i8, i8* %arrayidx551, align 1, !tbaa !11
  br label %for.cond53.preheader

for.cond53.preheader:                             ; preds = %for.cond.cleanup544, %for.cond48.preheader
  %19 = phi i8 [ %15, %for.cond48.preheader ], [ %17, %for.cond.cleanup544 ]
  ...
  %path1.01032 = phi i8* [ %l_path1_generic1186, %for.cond48.preheader ], [ %l_path0_generic1172, %for.cond.cleanup544 ]
  %path0.01031 = phi i8* [ %l_path0_generic1172, %for.cond48.preheader ], [ %l_path1_generic1186, %for.cond.cleanup544 ]
  %metric1.01030 = phi i8* [ %l_metric1_generic1185, %for.cond48.preheader ], [ %l_metric0_generic1184, %for.cond.cleanup544 ]
  %metric0.01029 = phi i8* [ %l_metric0_generic1184, %for.cond48.preheader ], [ %l_metric1_generic1185, %for.cond.cleanup544 ]
  %cmp59 = icmp eq i8 %19, 2
  %arrayidx89 = getelementptr inbounds i8, i8* %arrayidx31, i64 %second_symbol.01034
  br label %for.body56

for.cond.cleanup50:                               ; preds = %for.cond.cleanup544
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %sym1v1066) #2
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %sym0v1065) #2
...
for.body67:                                       ; preds = %for.body67, %for.cond63.preheader
  ...
  %21 = add nuw nsw i64 %indvars.iv1072, %20
  %arrayidx71 = getelementptr inbounds i8, i8* %arrayidx1, i64 %21
  %22 = load i8, i8* %arrayidx71, align 1, !tbaa !11
  %arrayidx74 = getelementptr inbounds [16 x i8], [16 x i8]* %sym1v, i64 0, i64 %indvars.iv1072
  %23 = load i8, i8* %arrayidx74, align 1, !tbaa !11
  %xor1004 = xor i8 %23, %22
  %arrayidx78 = getelementptr inbounds [16 x i8], [16 x i8]* %metsvm, i64 0, i64 %indvars.iv1072
  store i8 %xor1004, i8* %arrayidx78, align 1, !tbaa !11
  %sub = sub i8 1, %xor1004
  %arrayidx84 = getelementptr inbounds [16 x i8], [16 x i8]* %metsv, i64 0, i64 %indvars.iv1072
  store i8 %sub, i8* %arrayidx84, align 1, !tbaa !11
...
if.else:                                          ; preds = %for.body56
  %24 = load i8, i8* %arrayidx89, align 1, !tbaa !11
  %cmp91 = icmp eq i8 %24, 2
  %25 = shl i64 %indvars.iv1133, 4
...
for.body99:                                       ; preds = %if.else, %for.body99
  ...
  %26 = add nuw nsw i64 %indvars.iv1068, %25
  %arrayidx104 = getelementptr inbounds i8, i8* %inMemory, i64 %26
  %27 = load i8, i8* %arrayidx104, align 1, !tbaa !11
  %arrayidx107 = getelementptr inbounds [16 x i8], [16 x i8]* %sym0v, i64 0, i64 %indvars.iv1068
  %28 = load i8, i8* %arrayidx107, align 1, !tbaa !11
  %xor1091003 = xor i8 %28, %27
  %arrayidx112 = getelementptr inbounds [16 x i8], [16 x i8]* %metsvm, i64 0, i64 %indvars.iv1068
  store i8 %xor1091003, i8* %arrayidx112, align 1, !tbaa !11
  %sub116 = sub i8 1, %xor1091003
  %arrayidx119 = getelementptr inbounds [16 x i8], [16 x i8]* %metsv, i64 0, i64 %indvars.iv1068
  store i8 %sub116, i8* %arrayidx119, align 1, !tbaa !11
...
for.body299:                                      ; preds = %for.body299, %for.cond295.preheader
  ...
  %47 = add nuw nsw i64 %indvars.iv1085, %.pre-phi
  %arrayidx303 = getelementptr inbounds i8, i8* %path0.01031, i64 %47
  %48 = load i8, i8* %arrayidx303, align 1, !tbaa !11
  %49 = or i64 %indvars.iv1085, 1
  %50 = add nuw nsw i64 %49, %.pre-phi
  %arrayidx309 = getelementptr inbounds i8, i8* %path0.01031, i64 %50
  %51 = load i8, i8* %arrayidx309, align 1, !tbaa !11
  %conv310 = zext i8 %51 to i16
  %shl = shl nuw i16 %conv310, 8
  %conv311 = zext i8 %48 to i16
  %or312 = or i16 %shl, %conv311
  %shl315 = shl i8 %48, 1
  %arrayidx319 = getelementptr inbounds [16 x i8], [16 x i8]* %shift0, i64 0, i64 %indvars.iv1085
  store i8 %shl315, i8* %arrayidx319, align 2, !tbaa !11
  %52 = lshr i16 %or312, 7
  %conv321 = trunc i16 %52 to i8
  %arrayidx324 = getelementptr inbounds [16 x i8], [16 x i8]* %shift0, i64 0, i64 %49
  store i8 %conv321, i8* %arrayidx324, align 1, !tbaa !11
  %53 = add nuw nsw i64 %indvars.iv1085, %40
  %arrayidx329 = getelementptr inbounds i8, i8* %path0.01031, i64 %53
  %54 = load i8, i8* %arrayidx329, align 1, !tbaa !11
  %55 = add nuw nsw i64 %49, %40
  %arrayidx336 = getelementptr inbounds i8, i8* %path0.01031, i64 %55
  %56 = load i8, i8* %arrayidx336, align 1, !tbaa !11
  %conv337 = zext i8 %56 to i16
  %shl338 = shl nuw i16 %conv337, 8
  %conv339 = zext i8 %54 to i16
  %or340 = or i16 %shl338, %conv339
  %shl343 = shl i8 %54, 1
  %arrayidx347 = getelementptr inbounds [16 x i8], [16 x i8]* %shift1, i64 0, i64 %indvars.iv1085
  store i8 %shl343, i8* %arrayidx347, align 2, !tbaa !11
  %57 = lshr i16 %or340, 7
  %conv350 = trunc i16 %57 to i8
  %arrayidx353 = getelementptr inbounds [16 x i8], [16 x i8]* %shift1, i64 0, i64 %49
  store i8 %conv350, i8* %arrayidx353, align 1, !tbaa !11
...
for.body362:                                      ; preds = %for.body299, %for.body362
  ...
  %59 = load i8, i8* %arrayidx364, align 1, !tbaa !11
  %add366 = add i8 %59, 1
  store i8 %add366, i8* %arrayidx364, align 1, !tbaa !11
...
for.body378:                                      ; preds = %for.body378, %for.cond374.preheader
  ...
  %60 = load i8, i8* %arrayidx380, align 1, !tbaa !11
  %61 = add nuw nsw i64 %indvars.iv1097, %58
  %arrayidx385 = getelementptr inbounds i8, i8* %metric1.01030, i64 %61
  store i8 %60, i8* %arrayidx385, align 1, !tbaa !11
  %arrayidx387 = getelementptr inbounds [16 x i8], [16 x i8]* %survivor1, i64 0, i64 %indvars.iv1095
  %62 = load i8, i8* %arrayidx387, align 1, !tbaa !11
  %63 = or i64 %indvars.iv1097, 1
  %64 = add nuw nsw i64 %63, %58
  %arrayidx393 = getelementptr inbounds i8, i8* %metric1.01030, i64 %64
  store i8 %62, i8* %arrayidx393, align 1, !tbaa !11
...
for.body432:                                      ; preds = %for.body432, %for.cond428.preheader
  ...
  %69 = load i8, i8* %arrayidx434, align 1, !tbaa !11
  %70 = add nuw nsw i64 %indvars.iv1108, %65
  %arrayidx440 = getelementptr inbounds i8, i8* %metric1.01030, i64 %70
  store i8 %69, i8* %arrayidx440, align 1, !tbaa !11
  %arrayidx442 = getelementptr inbounds [16 x i8], [16 x i8]* %survivor1, i64 0, i64 %indvars.iv1106
  %71 = load i8, i8* %arrayidx442, align 1, !tbaa !11
  %72 = or i64 %indvars.iv1108, 1
  %73 = add nuw nsw i64 %72, %65
  %arrayidx449 = getelementptr inbounds i8, i8* %metric1.01030, i64 %73
  store i8 %71, i8* %arrayidx449, align 1, !tbaa !11
...
for.body459:                                      ; preds = %for.body432, %for.body459
  ...
  %74 = load i8, i8* %arrayidx461, align 1, !tbaa !11
  %arrayidx464 = getelementptr inbounds [16 x i8], [16 x i8]* %shift0, i64 0, i64 %indvars.iv1114
  %75 = load i8, i8* %arrayidx464, align 1, !tbaa !11
  %and466997 = and i8 %75, %74
  %neg470 = xor i8 %74, -1
  %arrayidx472 = getelementptr inbounds [16 x i8], [16 x i8]* %shift1, i64 0, i64 %indvars.iv1114
  %76 = load i8, i8* %arrayidx472, align 1, !tbaa !11
  %and474 = and i8 %76, %neg470
  %or475 = or i8 %and474, %and466997
  %arrayidx478 = getelementptr inbounds [16 x i8], [16 x i8]* %tmp1, i64 0, i64 %indvars.iv1114
  store i8 %or475, i8* %arrayidx478, align 1, !tbaa !11
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 1
  %exitcond1116 = icmp eq i64 %indvars.iv.next1115, 16
  br i1 %exitcond1116, label %for.body488, label %for.body459

for.body488:                                      ; preds = %for.body459, %for.body488
  %indvars.iv1119 = phi i64 [ %indvars.iv.next1120, %for.body488 ], [ 0, %for.body459 ]
  %indvars.iv1117 = phi i64 [ %indvars.iv.next1118, %for.body488 ], [ 0, %for.body459 ]
  %arrayidx490 = getelementptr inbounds [16 x i8], [16 x i8]* %tmp0, i64 0, i64 %indvars.iv1117
  %77 = load i8, i8* %arrayidx490, align 1, !tbaa !11
  %78 = add nuw nsw i64 %indvars.iv1119, %58
  %arrayidx495 = getelementptr inbounds i8, i8* %path1.01032, i64 %78
  store i8 %77, i8* %arrayidx495, align 1, !tbaa !11
  %arrayidx497 = getelementptr inbounds [16 x i8], [16 x i8]* %tmp1, i64 0, i64 %indvars.iv1117
  %79 = load i8, i8* %arrayidx497, align 1, !tbaa !11
  %80 = or i64 %indvars.iv1119, 1
  %81 = add nuw nsw i64 %80, %58
  %arrayidx503 = getelementptr inbounds i8, i8* %path1.01032, i64 %81
  store i8 %79, i8* %arrayidx503, align 1, !tbaa !11
  ...
  br i1 %exitcond1124, label %for.body514, label %for.body488
...
for.body514:                                      ; preds = %for.body488, %for.body514
  %indvars.iv1127 = phi i64 [ %indvars.iv.next1128, %for.body514 ], [ 0, %for.body488 ]
  %indvars.iv1125 = phi i64 [ %indvars.iv.next1126, %for.body514 ], [ 8, %for.body488 ]
  %arrayidx516 = getelementptr inbounds [16 x i8], [16 x i8]* %tmp0, i64 0, i64 %indvars.iv1125
  %82 = load i8, i8* %arrayidx516, align 1, !tbaa !11
  %83 = add nuw nsw i64 %indvars.iv1127, %65
  %arrayidx522 = getelementptr inbounds i8, i8* %path1.01032, i64 %83
  store i8 %82, i8* %arrayidx522, align 1, !tbaa !11
  %arrayidx524 = getelementptr inbounds [16 x i8], [16 x i8]* %tmp1, i64 0, i64 %indvars.iv1125
  %84 = load i8, i8* %arrayidx524, align 1, !tbaa !11
  %85 = or i64 %indvars.iv1127, 1
  %86 = add nuw nsw i64 %85, %65
  %arrayidx531 = getelementptr inbounds i8, i8* %path1.01032, i64 %86
  store i8 %84, i8* %arrayidx531, align 1, !tbaa !11
...
for.cond.cleanup544:                              ; preds = %for.cond.cleanup513
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %sym0v1065, i8 %17, i64 16, i1 false)
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %sym1v1066, i8 %18, i64 16, i1 false)
...
for.inc604:                                       ; preds = %for.inc604, %if.then566
  ...
  %87 = shl nuw nsw i64 %indvar, 4
  %scevgep1156 = getelementptr [24 x [64 x i8]], [24 x [64 x i8]]* %l_ppresult, i64 0, i64 %idxprom595, i64 %87
  %scevgep1157 = getelementptr [64 x i8], [64 x i8]* %l_path0_generic, i64 0, i64 %87
  %scevgep = getelementptr [64 x i8], [64 x i8]* %l_mmresult, i64 0, i64 %87
  %scevgep1155 = getelementptr [64 x i8], [64 x i8]* %l_metric0_generic, i64 0, i64 %87
...
for.end606:                                       ; preds = %for.inc604
  %88 = load i8, i8* %l_mmresult1187, align 16, !tbaa !11
  %conv609 = zext i8 %88 to i32
  br label %for.body616

for.cond640.preheader:                            ; preds = %for.body616
  %idxprom6471044 = sext i32 %spec.select1005 to i64
  %arrayidx6481045 = getelementptr inbounds [24 x [64 x i8]], [24 x [64 x i8]]* %l_ppresult, i64 0, i64 %idxprom595, i64 %idxprom6471044
  %89 = load i8, i8* %arrayidx6481045, align 1, !tbaa !11
...
for.body616:                                      ; preds = %for.body616, %for.end606
  ...
  %90 = load i8, i8* %arrayidx618, align 1, !tbaa !11
  %conv619 = zext i8 %90 to i32
  %cmp620 = icmp ult i32 %bestmetric.01039, %conv619
  %spec.select = select i1 %cmp620, i32 %conv619, i32 %bestmetric.01039
  %91 = trunc i64 %indvars.iv1159 to i32
  %spec.select1005 = select i1 %cmp620, i32 %91, i32 %beststate.01041
...
for.cond661.preheader:                            ; preds = %for.body644, %for.cond640.preheader
  %.lcssa = phi i8 [ %89, %for.cond640.preheader ], [ %95, %for.body644 ]
  %92 = trunc i32 %minmetric.1 to i8
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %l_path0_generic1172, i8 0, i64 64, i1 false)
  br label %for.cond665.preheader

for.body644:                                      ; preds = %for.cond640.preheader, %for.body644
  %93 = phi i8 [ %95, %for.body644 ], [ %89, %for.cond640.preheader ]
...
for.body668:                                      ; preds = %for.body668, %for.cond665.preheader
  ...
  %97 = add nuw nsw i64 %indvars.iv1163, %96
  %arrayidx676 = getelementptr inbounds [64 x i8], [64 x i8]* %l_metric0_generic, i64 0, i64 %97
  %98 = load i8, i8* %arrayidx676, align 1, !tbaa !11
  %conv679 = sub i8 %98, %92
  store i8 %conv679, i8* %arrayidx676, align 1, !tbaa !11
...
for.body698:                                      ; preds = %for.body698, %for.cond694.preheader
  ...
  %100 = trunc i64 %indvars.iv1173 to i32
  %101 = sub i32 7, %100
  %shr701 = lshr i32 %conv699, %101
  %102 = trunc i32 %shr701 to i8
  %conv703 = and i8 %102, 1
  %103 = add nuw nsw i64 %indvars.iv1173, %99
  %arrayidx708 = getelementptr inbounds i8, i8* %outMemory, i64 %103
  store i8 %conv703, i8* %arrayidx708, align 1, !tbaa !11
...
if.end713.loopexit:                               ; preds = %for.body698
  %104 = add i32 %n_decoded.01055, 8
  br label %if.end713

if.end713:                                        ; preds = %if.end713.loopexit, %for.end689
  %n_decoded.2 = phi i32 [ %n_decoded.01055, %for.end689 ], [ %104, %if.end713.loopexit ]
...
while.end:                                        ; preds = %if.end716, %while.cond.preheader
  call void @llvm.lifetime.end.p0i8(i64 1536, i8* nonnull %0) #2
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %l_mmresult1187) #2
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %l_path1_generic1186) #2
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %l_path0_generic1172) #2
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %l_metric1_generic1185) #2
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %l_metric0_generic1184) #2
  ret void
}
